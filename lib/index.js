...
class Service {
  ...
  // GET
  find (params) {
    return core.find(this, params)
      .catch(errorHandler);
  }

  // GET
  get (id, params) {
    return core.get(this, id, params)
  ...
  create (data, params) {
    ...
    if (!Array.isArray(data)) {
      return core.create(this, data, params)
        .catch(error => errorHandler(error, data[this.id]));
    }

    return core.createBulk(this, data, params)
      .catch(errorHandler);
  }
  ...
  update (id, data, params) {
    return core.update(this, id, data, params)
      .catch(error => errorHandler(error, id));
  }
  ...
  patch (id, data, params) {
    ...
    if (id !== null) {
      return core.patch(this, id, data, params)
        .catch(error => errorHandler(error, id));
    }

    return core.patchBulk(this, data, params)
      .catch(errorHandler);
  }
  ...
  remove (id, params) {
    if (id !== null) {
      return core.remove(this, id, params)
        .catch(error => errorHandler(error, id));
    }

    return core.removeBulk(this, params)
      .catch(errorHandler);
  }
  ...
  raw (method, params) {
    ...
    return core.raw(this, method, params)
      .catch(errorHandler);
  }
}
